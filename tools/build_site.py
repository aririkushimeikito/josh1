...
<header class="site-header">
  <div class="wrap site-header__row">
    <a class="brand" href="{href("")}"><span class="brand__name">Isabelle Joseph, <abbr title="Doctor of Nursing Practice">DNP</abbr></span></a>
...
.dd__caret{font-size:1.4em;margin-left:.3em;color:var(--ink-muted);display:inline-block;line-height:1;vertical-align:-.05em}
